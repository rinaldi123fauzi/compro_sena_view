        ...
        >
            ...
            <div class="absolute inset-0 hero-background">
                <img
                    ...
                    :alt="
                        staticText(
                            'Latar Belakang Sertifikasi SENA',
                            'SENA Certifications Background'
                        )
                    "
        ...
        >
            <div class="container mx-auto px-4 py-6">
                <div class="flex flex-wrap justify-center gap-4">
                    ...
                    >
                        {{ staticText("Sertifikat", "Certificates") }}
                    </button>
                    <button
                    ...
                    <p class="text-gray-500">
                        {{
                            staticText(
                                ...
                                "Try changing the filter to see other certifications"
                            )
                        }}
                    </p>
                </div>
    ...
    piagamData.value
        ...
        .map((item) => ({
            ...
            title:
                ...
                item.title ||
                item.nama ||
                "Untitled Certificate", // Support dual language
        }))
);
...
const awardData = computed(() =>
    piagamData.value
        ...
        .map((item) => ({
            ...
            image: item.image_url, // Use image_url from API for display
            title:
                t(item, "title") || item.title || item.nama || "Untitled Award", // Support dual language
        }))
);
...
onMounted(async () => {
    ...
    //
    document.title = "Sertifikasi & Penghargaan - PT SENA";
});
