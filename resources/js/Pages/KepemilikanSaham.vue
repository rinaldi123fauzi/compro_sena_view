        ...
        >
            ...
            <div class="relative z-10 container mx-auto px-4">
                <div class="text-center max-w-4xl mx-auto">
                    ...
                    >
                        {{ staticText("Kepemilikan", "Share") }}
                        <span class="text-[#cade52]">{{
                            staticText("Saham", "Ownership")
                        }}</span>
                    </h1>
                </div>
            </div>
            ...
            <div class="container mx-auto px-4">
                ...
                <!-- <div class="text-center mb-12">
                    ...
                    <p class="text-xl text-gray-600 max-w-3xl mx-auto">
                        Informasi lengkap mengenai struktur kepemilikan saham
                        dan distribusi kepemilikan di PT Solusi Energy Nusantara
                    </p>
                </div> -->
                    ...
                    >
                        ...
                        <div class="relative group">
                            <img
                                ...
                                :alt="
                                    staticText(
                                        'Kepemilikan Saham PT SENA',
                                        'Share Ownership PT SENA'
                                    )
                                "
        ...
        >
            <div class="relative max-w-7xl max-h-full">
                ...
                <img
                    ...
                    :alt="
                        staticText(
                            'Kepemilikan Saham PT SENA - Ukuran Penuh',
                            'Share Ownership PT SENA - Full Size'
                        )
                    "
                ...
                <div class="absolute -bottom-16 left-0 right-0 text-center">
                    <h3 class="text-white text-xl font-semibold">
                        {{
                            staticText(
                                "Struktur Kepemilikan Saham PT Solusi Energy Nusantara",
                                "Share Ownership Structure PT Solusi Energy Nusantara"
                            )
                        }}
                    </h3>
                </div>
